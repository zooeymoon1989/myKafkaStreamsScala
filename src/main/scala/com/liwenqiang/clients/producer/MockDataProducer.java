package com.liwenqiang.clients.producer;
...
import static com.liwenqiang.util.Topics.CLIENTS;
import static com.liwenqiang.util.Topics.COMPANIES;
import static com.liwenqiang.util.datagen.DataGenerator.NUMBER_UNIQUE_CUSTOMERS;
import static com.liwenqiang.util.datagen.DataGenerator.NUM_ITERATIONS;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class MockDataProducer {

    private static final Logger LOG = (Logger) LoggerFactory.getLogger(MockDataProducer.class);
    ...
    public static void produceStockTransactions(int numberIterations) {
        produceStockTransactions(numberIterations, DataGenerator.NUMBER_TRADED_COMPANIES, NUMBER_UNIQUE_CUSTOMERS, false);
    }
